...
export function TelemetryScrubber({
  currentTime,
  duration,
  onChange,
  className = "",
  ...
  return (
    <div className={`w-full bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 shadow-2xl flex items-center gap-4 ${className}`}>
